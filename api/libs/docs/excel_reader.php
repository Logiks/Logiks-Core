...
class Spreadsheet_Excel_Reader {
	...
	// Prints As AN HTML TABLE OF THE ENTIRE XLS DATA
	// =========================================
	function printSheet($row_numbers=false,$col_letters=false,$sheet=0,$table_class='excel') {
		return $this->dump($row_numbers,$col_letters,$sheet,$table_class);
	}
